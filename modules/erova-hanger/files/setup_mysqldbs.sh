...
mysql -uroot -e "create table if not exists trades.trades ( instrument varchar(30), InstrumentBegin timestamp , FuelType varchar(30), NormalCapacity float(10,5), plantID int not null auto_increment, primary key (plantID) )"
